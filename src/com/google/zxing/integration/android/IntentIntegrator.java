...
public class IntentIntegrator {
  ...
  public AlertDialog initiateScan() {
    return initiateScan( ALL_CODE_TYPES,null);
  }
   ...
   */
  public AlertDialog initiateScan(Collection<String> desiredBarcodeFormats, String message) {
...
//    Intent intentScan = new Intent(BS_PACKAGE + ".SCAN");
    ...
    if (desiredBarcodeFormats != null) {
      ...
      if (message != null) {
    	  intentScan.putExtra("PROMPT_MESSAGE", message);
      }
